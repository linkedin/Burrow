...
func (module *KafkaCluster) mainLoop(client sarama.Client) {
...
func (module *KafkaCluster) maybeUpdateMetadataAndDeleteTopics(client sarama.Client) {
...
func (module *KafkaCluster) generateOffsetRequests(client sarama.Client) (map[int32]*sarama.OffsetRequest, map[int32]*sarama.Broker) {
...
func (module *KafkaCluster) getOffsets(client sarama.Client) {
